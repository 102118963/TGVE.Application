...
:setvar DefaultDataPath "C:\Users\LachlanvanderVelden\AppData\Local\Microsoft\VisualStudio\SSDT"
:setvar DefaultLogPath "C:\Users\LachlanvanderVelden\AppData\Local\Microsoft\VisualStudio\SSDT"
...
GO
PRINT N'Rename refactoring operation with key 1e18fac6-e883-4b5d-9b7d-1bcb98a510e5, cc4d1a78-7435-422f-a4ad-ef5e1d6c3e50 is skipped, element [dbo].[Tours].[SessionStartTime] (SqlSimpleColumn) will not be renamed to TourStartTime';


GO
PRINT N'Rename refactoring operation with key c6a6c137-8840-4214-b4e1-d4ab8b145422 is skipped, element [dbo].[Tours].[SessionEndTime] (SqlSimpleColumn) will not be renamed to TourEndTime';


GO
PRINT N'Rename refactoring operation with key 3b0f196d-a13e-4697-a0d0-c231e927b4d9 is skipped, element [dbo].[Tours].[TeacherName] (SqlSimpleColumn) will not be renamed to Area';
